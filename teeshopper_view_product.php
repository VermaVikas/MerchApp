            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h4 mb-0 text-gray-800">Manage Products</h1>
...
<script>
    function onLoad(){
        //activeSubMenu("menuItemTeeshopper", true, "collapseTeeshopper", "menuItemTeeshopperViewProducts");
        activeMenu("menuItemTeeshopper");
        setPgTitle("Teeshopper Product Page");
    }
</script>
</html>